...
(function ($) {
    ...
    setTimeout(function () {
      if (window.___browserSync___ === undefined && Number(localStorage.getItem('Silvester:Demo:MessageShowed')) < Date.now()) {
        localStorage.setItem('Silvester:Demo:MessageShowed', (Date.now()) + (15 * 60 * 1000))
    ...
    $container.append(
      '<h5>Customize Silvester</h5><hr class="mb-2"/>'
    )
