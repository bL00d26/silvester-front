    ...
    return (
        <aside className="main-sidebar sidebar-dark-primary elevation-4">
            <a href="index3.html" className="brand-link">
                <img src="https://imgur.com/X7yIs7Y.png" alt="Silvester Logo" className="brand-image img-circle elevation-3" style={{ opacity: '.8' }} />
                <span className="brand-text font-weight-light">Silvester 3</span>
            </a>
            <div className="sidebar">
                <div className="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div className="image">
                        <img src="https://imgur.com/8UNAWR7.jpg" className="img-circle elevation-2" alt="User Image" />
                    </div>
                    <div className="info">
                    ...
                    <ul className="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li className="nav-item">
                            ...
                            <ul className="nav nav-treeview">
                                <li className="nav-item">
                                    <Link to="/admin/mi-tienda" className="nav-link">
                                        <i className="far fa-circle nav-icon text-info" />
                                        <p>Detalles de mi tienda</p>
                                    </Link>
                                </li>
                                <li className="nav-item">
                                    <Link to="/admin/mi-tienda/editar" className="nav-link">
                                        <i className="far fa-circle nav-icon text-success" />
                                        <p>Editar mi tienda</p>
                                    </Link>
                                </li>
                            </ul>
                        </li>
                        <li className="nav-item">
                            ...
                            <ul className="nav nav-treeview">
                                ...
                                <li className="nav-item">
                                    <Link to="/admin/productos/agregar" className="nav-link">
                                        <i className="far fa-circle nav-icon text-success" />
                        ...
                        <li className="nav-item">
                            <a href="https://silvester-shop.com/docs/3.1/" className="nav-link">
